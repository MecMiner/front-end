...
import { Respostas, respostasConstrutor } from '../interfaces/interfaces';

type ExercicioNivel2Props = {
    dicaProfessor: string,
    dicaAluno: string,
    onSucess: (respostasnivel2: string) => void
}

function ExercicioNivel2({ dicaAluno, dicaProfessor, onSucess }: ExercicioNivel2Props) {
    ...
    useEffect(() => {
        setRes(`Etapa 2 ${etapa2}; Etapa 4: ${etapa4}`)
        console.log(res)
    },  [etapa2, etapa4])
...
export default ExercicioNivel2;